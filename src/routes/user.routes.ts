...
import { checkUserExistsHandler, createSellerHandler, createUserHandler, sellerDocumentsHandler, sendPhoneOTPHandler, verifyOTPHandler } from "../controller/user.controller";
